...
void main(){
    ...
    reverse();
    printList();
    printf("TAILS = %d , %d, Next: %p, Previous: %p \n", tail->key, tail->data,tail->next, tail->previous);
    printf("HEAD = %d , %d Next: %p, Previous: %p \n", head->key, head->data,head->next, head->previous);
